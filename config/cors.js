...
module.exports.cors = {
  ...
  ***************************************************************************/
  ...
  origin: [
    ...
    'http://www.justinapp.co',
    'http://rayco.localhost:9000',
    'http://rayco.dilisap.localhost:9000',
    'http://condiser.dilisap.localhost:9000',
    "http://condiser.dilisap.localhost:9200",
    'http://condiser.localhost:9000',
  ].join(','),
  ...
  ***************************************************************************/
  ...
  //headers: 'content-type, appname, hostname, authorization'
  headers: (function(){
    var headers = [
